...
public class ReportWriter {
    ...
    private static String TASK_ROW =
            "│                                │ %2$-30s │   %3$s   │   %4$s   │    %5$s    │     %6$s      │ %7$s │ %8$5.1f │             │%n";
    private static String FIRST_TASK_ROW =
            "│ %1$-30s │ %2$-30s │   %3$s   │   %4$s   │    %5$s    │     %6$s      │ %7$s │ %8$5.1f │       %9$5.1f │%n";
    ...
    private void printTaskReport(TaskResult taskResult, String studentName,
        ...
        String javadocStatus = taskResult.javadocSuccess() ? "+" : "-";
        String checkstyleStatus = taskResult.checkstyleSuccess() ? "+" : "-";
        String testsStatus;
