...
public class PolynomialTest {
    ...
    void test_multiply() {
        ...
        assertEquals(p1.times(p2).toString(), "583x^12 - 228x^11 - 1032x^10 + 1125x^9 + 719x^8 + 16x^7 - 1735x^6 - " +
                "113x^5 + 111x^4 + 94x^3 - 25x^2 + 155x + 50");
    }
    ...
    void test_differentiation() {
        ...
        assertEquals(p1.differentiate(0).toString(), "x^7 + 13x^6 - 10x^5 + 11x^4 + 7x^3 + 3x^2 - 5x + 10");
    }
